/// draw_sprite_tiled_area(sprite,subimg,x,y,x1,y2,x2,y2,col,alpha)
//
...
/// GMLscripts.com/license
    var sprite,subimg,xx,yy,x1,y1,x2,y2,col,alpha;
    sprite = argument0;
    subimg = argument1;
    xx = argument2;
    yy = argument3;
    ...
    for(i=i; i<=x2; i+=sw) {
        for(j=j; j<=y2; j+=sh) {
            ...
            draw_sprite_part_ext(sprite,subimg,left,top,width,height,X,Y,1,1,col,alpha);
        }
        j = jj;
    }
    return 0;
