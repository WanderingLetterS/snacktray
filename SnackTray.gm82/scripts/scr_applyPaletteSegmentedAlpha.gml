///scr_applyPaletteSegmentedAlpha(psPalSwapid,palette sprite,collumn1,collumn2,collumn3,collumn4,xoffset,alpha,totalpal)
...
shader_pixel_uniform_f("_totalPaletteWidth",argument[8])
shader_pixel_uniform_f("_maxAlpha",argument[7])
